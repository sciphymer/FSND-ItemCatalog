...
auth = HTTPBasicAuth()
sqliteDB_connStr = ['sqlite:////var/www/FlaskApp/FlaskApp/users.db','sqlite:////var/www/FlaskApp/FlaskApp/sportCategories.db']
postgreSQL_connStr = 'postgresql://dbadmin:dbadmin@localhost:5432/flaskappDB'
#user_engine = create_engine(postgreSQL_connStr, connect_args={'check_same_thread': False})
#app_engine = create_engine(postgreSQL_connStr, connect_args={'check_same_thread': False})
user_engine = create_engine(postgreSQL_connStr)
...
path_to_client_secrets = os.path.dirname(__file__) + '/client_secrets.json'
...
def gconnect():
	...
	try:
		...
		oauth_flow = flow_from_clientsecrets(path_to_client_secrets, scope='')
